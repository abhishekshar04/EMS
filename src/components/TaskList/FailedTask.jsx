...
function FailedTask({task,color}) {
    return (
        <div className={`flex-shrink-0 flex flex-col justify-between p-5 h-full w-[300px] ${color} rounded-2xl overflow-auto`}>
            ...
            <div className='flex justify-between mt-5 flex-col gap-5'>
                <button className='bg-red-500 py-1 px-2 text-sm cursor-pointer hover:bg-red-400'>Failed</button>
            </div>
          </div>
    )
}
